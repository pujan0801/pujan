                ...
                <blockquote className="blockquote mb-0">
                    ...
                    <p style={{textAlign:("left")}}>
                        ...
                        <i>
                            ...
                            <b style={{fontSize: "0.8em"}}> February 2023 - present 2023 </b>
                        </i>
                    </p>
                    <li className="about-activity" style={{fontSize: "0.8em"}}>
                        The main objective remained the same throughout the second month of my internship, and I continued to manage every aspect of the product, including the legal processes.
                        <div>
                            <br/>
