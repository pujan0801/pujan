                ...
                <blockquote className="blockquote mb-0">
                    ...
                    <p style={{textAlign:("left")}}>
                        ...
                        <i>
                            ...
                            <b style={{fontSize: "0.8em"}}> September 2022 - December 2022 </b>
                        </i>
                    </p>
                    <li className="about-activity" style={{fontSize: "0.8em"}}>
                    ...
                    <p style={{textAlign:("left")}}>
                        <span className="purple" style={{fontSize: "1.4em"}}>Marwiz Tech Private Limited, Vadodara</span> <br/>
                        <i>
                            <b style={{fontSize: "0.8em", color: "#E5A5FC"}}>AI/ML Intern </b> <br/>
                            <b style={{fontSize: "0.8em"}}> January 2023 - February 2023 </b>
                        </i>
                    </p>
                    <li className="about-activity" style={{fontSize: "0.8em"}}>
                        The main aim of internship was to assist the organization in developing the Machine learning models to provide the customers with proper analytics of the viewers of the advertisements.
                        <div>
                            <br/>
                            <a href="https://drive.google.com/file/d/1EkqnFVr9-n5tYHXsUEzow9TBcppR2VgQ/view?usp=share_link" target="_blank">
                                <button className="btn-primary">Certification</button>
                            </a>
                        </div>
                    </li> <br/> <br/>
                    ...
                    <p style={{textAlign:("left")}}>
                        <span className="purple" style={{fontSize: "1.4em"}}>Marwiz Tech Private Limited, Vadodara</span> <br/>
                        <i>
                            <b style={{fontSize: "0.8em", color: "#E5A5FC"}}>AI/ML Engineer </b> <br/>
                            <b style={{fontSize: "0.8em"}}> February 2023 - July 2023 </b>
                        </i>
                    </p>
                    <li className="about-activity" style={{fontSize: "0.8em"}}>
                        The main objective remained the same throughout my internship, and I continued to manage every aspect of the product, including the legal processes.
                        <div>
                            <br/>
                            <a href="https://drive.google.com/file/d/14gu34fOU0xlq0immjfEUo4wdJGi9KPle/view?usp=drive_link" target="_blank">
                                <button className="btn-primary">Certification</button>
                            </a>
                        </div>
                    </li> <br/> <br/>
                    ...
                    <p style={{textAlign:("left")}}>
                        ...
                        <i>
                            <b style={{fontSize: "0.8em", color: "#E5A5FC"}}>AI/ML Engineer </b> <br/>
                            <b style={{fontSize: "0.8em"}}> July 2023 - January 2024 </b>
                        </i>
                    </p>
                    <li className="about-activity" style={{fontSize: "0.8em"}}>
                        The main objective was to handle every technical as well as non-technical tasks, and I also continued to manage every aspect of the product, including the legal processes.
                        <div>
                            <br/>
                            <a href="https://drive.google.com/file/d/14gu34fOU0xlq0immjfEUo4wdJGi9KPle/view?usp=drive_link" target="_blank">
                                <button className="btn-primary">Certification</button>
